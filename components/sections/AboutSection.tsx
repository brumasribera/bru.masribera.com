...
export function AboutSection() {
  ...
  return (
    <section id="about" className="py-6 sm:py-12 px-4 sm:px-6 lg:px-8 bg-white dark:bg-gray-900">
          ...
          <div className="relative group rounded-2xl p-[1px] bg-gradient-to-br from-emerald-500/20 via-teal-500/10 to-cyan-500/20 transition-all">
            <Card className="relative rounded-2xl bg-white/75 dark:bg-gray-800/70 backdrop-blur-sm p-4 sm:p-7 shadow-sm ring-1 ring-black/5 dark:ring-white/10 group-hover:shadow-xl group-hover:-translate-y-1 transition-all h-full">
              <CardContent className="p-0 h-full flex flex-col">
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white mb-2">{t('about.frontend.title')}</h3>
                <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 flex-grow">{t('about.frontend.desc')}</p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="relative group rounded-2xl p-[1px] bg-gradient-to-br from-fuchsia-500/20 via-pink-500/10 to-rose-500/20 transition-all">
            <Card className="relative rounded-2xl bg-white/75 dark:bg-gray-800/70 backdrop-blur-sm p-4 sm:p-7 shadow-sm ring-1 ring-black/5 dark:ring-white/10 group-hover:shadow-xl group-hover:-translate-y-1 transition-all h-full">
              <CardContent className="p-0 h-full flex flex-col">
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white mb-2">{t('about.ux.title')}</h3>
                <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 flex-grow">{t('about.ux.desc')}</p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="relative group rounded-2xl p-[1px] bg-gradient-to-br from-violet-500/20 via-purple-500/10 to-indigo-500/20 transition-all">
            <Card className="relative rounded-2xl bg-white/75 dark:bg-gray-800/70 backdrop-blur-sm p-4 sm:p-7 shadow-sm ring-1 ring-black/5 dark:ring-white/10 group-hover:shadow-xl group-hover:-translate-y-1 transition-all h-full">
              <CardContent className="p-0 h-full flex flex-col">
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white mb-2">{t('about.research.title')}</h3>
                <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 flex-grow">{t('about.research.desc')}</p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="relative group rounded-2xl p-[1px] bg-gradient-to-br from-amber-500/20 via-orange-500/10 to-rose-500/20 transition-all">
            <Card className="relative rounded-2xl bg-white/75 dark:bg-gray-800/70 backdrop-blur-sm p-4 sm:p-7 shadow-sm ring-1 ring-black/5 dark:ring-white/10 group-hover:shadow-xl group-hover:-translate-y-1 transition-all h-full">
              <CardContent className="p-0 h-full flex flex-col">
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white mb-2">{t('about.innovation.title')}</h3>
                <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 flex-grow">{t('about.innovation.desc')}</p>
              </CardContent>
            </Card>
          </div>
        </div>
