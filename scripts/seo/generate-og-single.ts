...
const imageName: string = args[0] || 'main';
...
async function generateSingleImage(browser: puppeteer.Browser, pageConfig: ImageConfig): Promise<void> {
...
export { generateSingleImage, IMAGE_CONFIG };
