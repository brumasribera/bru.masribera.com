         ...
         <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           ...
           <div className="text-center">
             ...
             <p className="text-2xl text-blue-100 max-w-4xl mx-auto leading-relaxed">
               Advanced snow monitoring and avalanche prediction system using satellite data and AI. 
               The DeFROST project demonstrates our capabilities in environmental monitoring and climate research.
             </p>
           </div>
         </div>
       </div>
            ...
            <CardContent className="flex-1 flex flex-col space-y-4">
              <div className="flex-1">
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-lg">
                  ...
                  at 20m resolution. Our service helps outdoor platforms, tourism offices, and adventure enthusiasts make informed decisions.
                </p>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-lg">
                ...
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-lg">
                  We're expanding into the energy market, specifically for hydropower plant operators, demonstrating the value of 
          ...
          <Card className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 border border-blue-200 dark:border-blue-700 rounded-3xl shadow-lg">
            <CardContent className="p-8">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                and continue expanding Wegaw's foothold in the energy market while maintaining our leadership 
